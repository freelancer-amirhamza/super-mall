        ...
        <section className="fixed top-0 left-0 p-2  right-0 bottom-0 flex items-center justify-center bg-neutral-900/80 ">
            <div className="max-w-2xl w-full p-4 rounded-sm  bg-white">
                <div className="flex justify-between items-center">
                    <h1 className="text-lg font-semibold text-neutral-700">Category</h1>
                ...
                <form className="mt-4">
                    ...
                    <div className="flex justify-between mt-4">
                        <div onClick={handleSubmit} className={`${!formData?.name || !formData?.image ? "cursor-not-allowed text-neutral-400 " : "hover:bg-amber-600 hover:text-white border-amber-600" }  border  px-2 py-1 rounded-sm  transition-colors duration-300`} >Add Category</div>
